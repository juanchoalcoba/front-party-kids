  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center">
        ...
        <a
          href="https://wa.me/59898015337"
          className=" bg-green-600 hover:bg-green-700 transition text-white font-light px-6 py-3 mt-4 rounded-full flex items-center justify-center gap-2 mx-auto mb-12"
        >
          <FaWhatsapp className="text-xl" /> ¡Consulta más detalles por
          WhatsApp!
        </a>
      </div>
