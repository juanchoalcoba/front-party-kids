...
const Hero = () => {
  ...
  return (
    <div
      id="reservas"
      className="relative h-dvh w-screen overflow-x-hidden bg-violet-950"
    >
      <div
        id="image-frame"
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-8 min-h-screen px-5 sm:px-10 flex flex-col justify-center items-center">
            <h1
              ...
              style={{
                backgroundImage:
                  "linear-gradient(to right, #FFCCE5, #FF8CFF, #A7D8FF, #FFEC6D)",
            ...
            <h1
              ...
              style={{
                backgroundImage:
                  "linear-gradient(to right, #FAE78C, #FF66A6, #FF8F5A, #60E36D)",
                WebkitBackgroundClip: "text",
                color: "transparent",
                WebkitTextStroke: "0.8px black",
                textShadow: "1px 1px 2px rgba(0, 0, 0, 0.02)",
            ...
            <p className="mb-5 text-center max-w-64 text-[20px] text-white font-robert-medium ">
              ...
              <br />
              para los mas chiquitos y grandes tambien!!
            </p>
            <Link to="booking">
              <Button
                id="watch-trailer"
