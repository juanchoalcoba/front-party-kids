    ...
    >
      ...
      >
        ...
        <div className="flex justify-center items-start flex-col text-gray-950 text-lg mt-4">
          ...
          <div className="flex items-center gap-2">
            <FaGlassCheers className="text-yellow-600" />
        ...
        <p className="text-center text-cyan-950 font-bold font-circular-web mb-2 pt-4 text-[20px]">
          CONSULTAR FECHA
        </p>
        ...
        <div className="flex justify-center gap-8 mt-4">
          <Link
            target="_blank"
            to="https://www.tiktok.com/@kids.party.pdlt?_t=ZM-8tXN5ZUyAMf&_r=1"
          >
            <SiTiktok className="text-gray-800 text-4xl hover:text-gray-900 transition-all duration-300" />
          </Link>

          <Link
            to="https://www.instagram.com/kidsparty.pdlt?igsh=MWt0eTdpMTdvdDBiMQ=="
            target="_blank"
          >
