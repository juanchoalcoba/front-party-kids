...
const PrivatePage = () => {
  ...
  const handleViewed = async (name) => {
    const viewed = window.confirm(
      "¿Estás seguro de que quieres Leer esta reserva?"
    );
    if (!viewed) return;
          ...
          <table className="min-w-full table-auto bg-gray-800 text-white shadow-md rounded-lg text-sm">
            <thead>
              <tr className="bg-gray-700 text-gray-300 text-left">
                ...
                <th className="px-4 py-2 font-semibold">Leer/vista</th>
                ...
                >
                  ...
                  <td className="px-4 py-2 text-gray-300">
                    <input
                      ...
                      checked={booking.viewedByAdmin} // Mantén el checkbox marcado si está leído
                    />
                  </td>
