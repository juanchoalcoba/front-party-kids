                                    ...
                                    <td className="px-4 py-2">
                                        <div className="flex flex-col gap-2 sm:flex-row">
                                            <button
                                                ...
                                                className="py-2 px-4 bg-red-600 text-white rounded hover:bg-red-700 transition duration-300 w-full sm:w-auto"
                                            >
                                                Eliminar
                                            </button>
                                            <button
                                                onClick={() => handleConfirm(booking.name)}
                                                className={`ml-4 py-2 px-4 ${booking.confirmed ? 'bg-green-500' : 'bg-blue-600'} text-white rounded hover:bg-green-600 transition duration-300 w-full sm:w-auto`}
                                            >
