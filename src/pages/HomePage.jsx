...
function HomePage() {
  return (
    <div className="relative flex flex-col justify-center items-center w-full min-h-screen">
      ...
      <div className="relative z-10 bg-white/40 backdrop-blur-sm p-8 rounded-3xl shadow-lg max-w-xl text-center">
        ...
        <p className="text-center text-blue-950 font-bold text-[20px]">Reserva tu Party DAY!!!</p>
